...
const Subscrib = () => {
  return (
    <div className='sub_bg_img py-20'>
      <div className='lg:w-4/12 mx-auto '>
        <h1 className='text-center text-white text-3xl font-bold tracking-[.30em]'>Subscription</h1>
        <img src={sub} className='w-2/4 mx-auto' alt="" />

        <div class="form-control w-8/12 mx-auto">
          <h2 className='py-3 font-bold text-center text-white'>Subscrib to get the latest <span className='text-red-600'>news & updates</span></h2>
